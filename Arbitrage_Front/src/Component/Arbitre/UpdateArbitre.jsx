...
function UpdateArbitre() {
    ...
    const {
        ...
        '/arbitre',
        '/dashboard/composants/updatedArbitre'
    );
            ...
            <>
                ...
                <div className="px-4 d-lg-none">
                    <div className="text-center col-sm-12 col-xl-6">
                        <div className="p-4 rounded bg-secondary h-100">
                            <SkeletonTheme baseColor="#3a3f5c" highlightColor="#6C7293">
                                <div className="mb-4 row d-flex align-items-center justify-content-center">
                                    <div className="col-7">
                                        <Skeleton height={40} />
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 row mt-lg-3 d-flex justify-content-between">
                                    <div className="col-6">
                                        <Skeleton height={35} />
                                    </div>
                                    <div className="col-6">
            ...
            <div className="text-center col-sm-12 col-xl-6">
                <div className="p-4 rounded bg-secondary h-100">
                    ...
                    <div className="mb-4">
                        ...
                        <p className="mb-0 text-white-50">عدّل بيانات الحكم</p>
                    </div>
